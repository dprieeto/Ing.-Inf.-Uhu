        ...
        case '2':
            do
            {
                ...
                do
                {
                    ...
                    case 'h':
                        cadena origen;
                        cout<<"\nIntroduce el origen para ver el numero de autobuses que salen de ahi."<<endl;
                        cin>>origen;
                        its.numerobuses(origen);
            ...
            its.itinerariosenintervalo(hini, hfin);
            break;
        case '4':
            break;
        }
