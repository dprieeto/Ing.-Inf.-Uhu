...
stack segment
    dw   128  dup(0)     ;dw reserva el doble de 128 de memoria es decir 256
ends
...
start:
    ...
    MOV CL, 'B'         ;Para mostrar las letras por pantalla
    MOV ES:[0], CX
    MOV CL, 'I'
    MOV ES:[2], CX
    MOV CL, 'N'
    ...
    ADD AL, 48        ;Para mostrar por pantalla tiene que ser en el codigo ASCII
    MOV ES:[8], AL
    MOV ES:[9], CH 
    ADD AH, 48
    MOV ES:[10], AH
...
mov ax, 4c00h ;
int 21h ;finaliza y devuelve el control 
